 ...
 * Proporciona métodos para cifrar y descifrar texto usando AES en modo GCM, así
 * como métodos para generar hashes usando varios algoritmos (MD5, SHA1, SHA256,
 * etc.).
 */
public class AESUtil {
	 ...
	 * @param iv        Vector de inicialización (debe ser el mismo utilizado para
	 *                  cifrar)
	...
	/**
	 * Descifra un texto utilizando una clave y vector de inicialización
	 * predeterminados.
	 *
	 * @param encrypted Texto cifrado en formato Base64
	 * @return Texto descifrado
	...
	/**
	 * Cifra un texto utilizando una clave y vector de inicialización
	 * predeterminados.
	 *
